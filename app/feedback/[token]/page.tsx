...
import styles from "@/app/soporte/[token]/Soporte.module.css";
import propios from "./Feedback.module.css";
...
type Props = {
  ...
  searchParams: Promise<{ ok?: string; error?: string; trabajo?: string }>;
};
          ...
          <div className={`container ${styles.grid}`}>
            ...
            <aside className={styles.ayuda}>
              ...
              <p className={styles.ayudaLista}>
                ...
                <a className={propios.link} href={`/soporte/${token}/`}>
                  Cargalo en soporte
                </a>
                .
              </p>
