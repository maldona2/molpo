...
import styles from "./Opinar.module.css";
  ...
  return (
    <fieldset className={styles.grupo}>
      ...
      <div className={styles.escala}>
        {PUNTAJES.map((p) => (
          <label key={p} className={styles.opcion}>
            <input type="radio" name={name} value={p} required />
            <span className={styles.opcionNumero}>{p}</span>
            <span className={styles.opcionTexto}>{leyenda(p)}</span>
          </label>
        ))}
      </div>
    </fieldset>
    ...
    <div className={`container ${styles.wrap}`}>
      <div className={styles.encabezado}>
        ...
        <p className={styles.bajada}>
          Terminamos una auditoría, un desarrollo o un pedido de soporte y quiero saber qué te
          sirvió y qué no. Son dos minutos y me sirven para el próximo trabajo.
        </p>
      </div>
      ...
      <div className={styles.grid}>
        <form className={styles.form} action={crearFeedback}>
          ...
          <Escala name="puntaje" titulo="Puntaje general" leyenda={(p) => PUNTAJE_ETIQUETAS[p]} />
          ...
          <fieldset className={styles.grupo}>
            <legend className={styles.legend}>Contanos más</legend>
            <label className={styles.field}>
          ...
          <fieldset className={styles.grupo}>
            <legend className={styles.legend}>Tus datos (opcional)</legend>
            <div className={styles.row}>
              <label className={styles.field}>
                <span>Tu nombre</span>
        ...
        <aside className={styles.ayuda}>
          ...
          <p className={styles.ayudaExtra}>
            ¿Necesitás reportar un bug o pedir una mejora?{" "}
            <a className={styles.link} href="/pedidos/">
              Cargalo en pedidos
            </a>
            .
          </p>
